...
import {Feedback, setAnswers, setQuestions} from '../../features/InsightsSlice'
...
const  QAInsights:React.FC =()=> {
  const Questions=useSelector((state:stateType)=>state.historyInsights.questions)
  const Answers=useSelector((state:stateType)=>state.historyInsights.answers)
        ...
        <div className="h-full flex justity-center items-center lg:w-[900px] md:w-[300] md:m-9 m-9 flex-col  text-white  ">
...

                {
                    ...
                    Questions.map((question:string, index:number)=>
                        <div className="mb-3 md:mb-9   bg-[#10132E] rounded">
